...
<body>
	...
	<div class="select_box">
		...
		<form action="map.do" id="form1" name="form1" method="post">
			<label for="year">请选择年份</label> <select name="year" id="year">
				<option value="1997">1997</option>
				<option value="2000">2000</option>
				<option value="2004">2004</option>
				<option value="2006">2006</option>
			</select> <input type="submit" name="query" value="查询" onclick="chose()">
		</form>
	...
	<script type="text/javascript">
		...
		function rkthemeInit() {
			...
			// 使用
			require([ 'echarts', 'echarts/chart/pie', 'echarts/chart/map',
